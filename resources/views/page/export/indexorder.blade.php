            ...
            <div id="table" style="width:100%">
                <table>
                    ...
                    @foreach ($print->listall as $key => $row)
                        <tr class="service">
                            <td class="tableitem">
                                <p class="itemtextname" style="margin: 0">{{ $row }}<br>
                                    จน.{{ $print->listcount[$key] }} x
                                    {{ $print->listprice[$key] }} </p>
                            </td>

                            <td class="tableitem">
                                <p class="itemtext" style="font-size: 0.4cm;margin: 0">
                                    {{ $print->listprice[$key] * $print->listcount[$key] }} </p>
                            </td>
                        </tr>
                        @php
                    ...
                    <tr class="tabletitle" style="margin: 0">
                        <td style="font-size: 0.4cm">ยอดรวม</td>



                        <td style="font-size: 0.4cm">
                            <h2>{{ $print->total_price }} บาท</h2>
                        </td>
                    ...
                    <tr class="tabletitle">
                        ...
                        <td>
                            <h2> {{ $ThaiFormat->makeFormat($print->created_at) }}</h2>
                        </td>
