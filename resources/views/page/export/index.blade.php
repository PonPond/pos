            ...
            <div id="table" style="width:100%">
                <table>
                            ...
                            <tr class="service">
                                <td class="tableitem">
                                    <p class="itemtextname" style="margin: 0">{{ $row }} <br>
                                        จน.{{ $item->listcount[$key] }} x
                                        {{ $item->listprice[$key] }} </p>
                                </td>
                                <!-- <td class="tableitem"><p class="itemtext" style="font-size: 0.4cm">{{ $item->listcount[$key] }}</p></td> -->
                                <td class="tableitem">
                                    <p class="itemtext" style="font-size: 0.4cm;style="margin: 0"">
                                        {{ $item->listprice[$key] * $item->listcount[$key] }} </p>
                                </td>
                                @php
                    ...
                    <tr class="tabletitle">
                        ...
                        @foreach ($order_receipt as $item)
                            <td>
                                <h2> {{ $ThaiFormat->makeFormat($item->created_at) }}</h2>
                            </td>
                        @endforeach
                    </tr>
