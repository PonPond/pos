    ...
    <div class="col-lg-10">
        ...
        <div class="card">
            <div class="card-header p-3 pt-2">
                ...
                <h5>รายการสินค้า</h5> <a href="https://27.254.144.129/phpMyAdmin/index.php?route=/sql&pos=0&db=admin_pos&table=products"  target="_blank" class="btn btn-primary" style="float: left;">ข้อมูลสินค้า</a>
